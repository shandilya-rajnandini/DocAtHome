            ...
            <div className="flex space-x-2 overflow-x-auto pb-4">
              {availableDates.map((date) => (
                <button
                  ...
                  className={`p-4 rounded-lg text-center w-20 flex-shrink-0 ${selectedDate === date.fullDate ? "bg-accent-blue text-white" : "bg-primary-dark text-secondary-text"}`}
                >
            ...
            <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-3 mt-6">
              {timeSlots.map((time) => (
                <button
                  ...
                  className={`p-3 rounded-lg ${selectedTime === time ? "bg-accent-blue text-white" : "bg-primary-dark text-secondary-text border border-gray-700"}`}
                >
                  {time}
                </button>
              ))}
            ...
            <div className="mt-6">
              ...
              <div className="flex rounded-lg border border-gray-700">
                <button
                  ...
                  className={`w-1/2 p-3 rounded-l-lg ${bookingType === "In-Home Visit" ? "bg-accent-blue text-white" : "bg-primary-dark"}`}
                >
                  In-Home
                </button>
                <button
                  onClick={() => setBookingType("Video Consultation")}
                  className={`w-1/2 p-3 rounded-r-lg ${bookingType === "Video Consultation" ? "bg-accent-blue text-white" : "bg-primary-dark"}`}
                >
                  Video Call
                </button>
              </div>
