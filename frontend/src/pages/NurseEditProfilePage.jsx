...
import { getMyProfile, updateMyProfile, disableTwoFactor, deactivateAccount } from '../api';
        ...
        <div>
            <div className="relative bg-[url('/nurse-profile-bg.jpg')] bg-cover bg-center h-60">
                <div className="absolute inset-0 bg-black bg-opacity-60 flex justify-center items-center">
                    <h1 className="text-5xl font-bold text-white">Edit Your Nursing Profile</h1>
                </div>
            </div>
            <div className="container mx-auto p-8">
                <form onSubmit={onSubmit} className="max-w-4xl mx-auto bg-secondary-dark p-8 rounded-lg shadow-lg">
                    <div className="flex flex-col items-center mb-8">
                        <img src={profile.profilePictureUrl || "/nurse-avatar.jpg"} alt="Profile" className="w-40 h-40 rounded-full object-cover border-4 border-teal-400" />
