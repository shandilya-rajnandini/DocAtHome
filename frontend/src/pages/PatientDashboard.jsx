...
const PatientDashboard = () => {
  ...
  // Use the useApi hook for handling adherence data
  const { data: adherenceData, request: fetchAdherence } = useApi(
    getAdherenceData,
    {
      showToastOnError: false, // Silent error handling for dashboard
    }
  );
    ...
    <main className="bg-amber-200 dark:bg-primary-dark min-h-full pt-24 pb-12 px-4">
      <div className="container mx-auto">
        <header className="mb-8 md:mb-12">
          ...
          <p className="text-base md:text-lg text-gray-800 dark:text-secondary-text mt-2">
