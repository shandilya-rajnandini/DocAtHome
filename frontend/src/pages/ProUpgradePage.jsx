...
const ProUpgradePage = () => {
  ...
  useEffect(() => {
    if (user && !["doctor", "nurse"].includes(user.role)) {
      toast.error(
        "Pro subscription is only available for healthcare professionals",
      );
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white dark:bg-secondary-dark rounded-lg shadow-xl p-8 text-center">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 mb-6">
              You have access to all Pro features until{" "}
        ...
        <div className="bg-white dark:bg-secondary-dark rounded-xl shadow-2xl overflow-hidden max-w-md mx-auto mb-12">
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-8 text-center">
            ...
            <p className="text-sm text-blue-100 mt-2">
              Lower platform fees • Higher visibility
            </p>
          </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Get "Pro" badge and appear at the top of search results
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Get insights with the "Demand Hotspot" map feature
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Pay only 15% instead of 20% platform fees
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-white">
                    Peer-to-Peer Case Review Forum
                  </h4>
                  <p className="text-gray-600 dark:text-gray-300">
                    Access exclusive professional community features
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white dark:bg-secondary-dark rounded-lg shadow-lg p-8">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Pro doctors get 3x more visibility in search results and
                  patient inquiries.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Lower commission means more earnings from each consultation.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  See where demand is highest and optimize your service areas.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Connect with peers and share knowledge in exclusive forums.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300">
                ...
                continue to have access until the end of your billing cycle.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300">
                ...
                banking through our secure payment partner Razorpay.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Yes! Your Pro badge and higher search ranking will be active
