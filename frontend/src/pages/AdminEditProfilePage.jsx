  ...
  return (
    <div>
      ...
      <div className="container mx-auto p-8">
        <form
          onSubmit={onSubmit}
          className="max-w-2xl mx-auto bg-secondary-dark p-8 rounded-lg shadow-lg"
        >
          <div className="flex flex-col items-center mb-8">
            ...
            <label
              ...
              className="mt-4 bg-blue-600 text-white font-bold py-2 px-4 rounded cursor-pointer hover:bg-blue-700"
            >
              Upload New Picture
            </label>
            <input
