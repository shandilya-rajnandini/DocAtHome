  ...
  return (
    <div className="bg-amber-300 dark:bg-primary-dark">
      ...
      <div className="relative bg-[url('/video-consult-bg.jpg')] bg-cover bg-center h-72">
        <div className="absolute inset-0 bg-black bg-opacity-60 flex flex-col justify-center items-center text-center text-white p-4">
          ...
          <p className="mt-4 text-xl">
            Consult with top doctors from the comfort of your home.
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto p-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center text-white">
            <div className="bg-white dark:bg-secondary-dark p-6 rounded-lg">
              ...
              <p className="text-black dark:text-secondary-text">
                Choose from our list of verified and experienced specialists.
              </p>
            </div>
            <div className="bg-white dark:bg-secondary-dark p-6 rounded-lg">
              <h3 className="text-xl font-semibold text-accent-blue mb-2">
              ...
              <p className="text-black dark:text-secondary-text">
                Pick a convenient date and time on the doctor's profile.
              </p>
            </div>
            <div className="bg-white dark:bg-secondary-dark p-6 rounded-lg">
              <h3 className="text-xl font-semibold text-accent-blue mb-2">
              ...
              <p className="text-black dark:text-secondary-text">
                Join the secure video call at the scheduled time from your
                dashboard.
              </p>
            </div>
          </div>
        ...
        <section>
          <h2 className="text-3xl font-bold text-center text-black dark:text-white mb-8">
            Doctors Available for Video Consultation
          </h2>
          {loading ? (
            ...
            <div className="space-y-4 max-w-4xl mx-auto">
              {doctors.length > 0 ? (
                doctors.map((doc) => (
                  <VideoDoctorCard key={doc._id} doctor={doc} />
                ))
              ) : (
                <p className="text-center text-black dark:text-secondary-text">
