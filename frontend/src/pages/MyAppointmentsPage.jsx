                ...
                <div className="bg-accent-cream dark:bg-secondary-dark p-6 rounded-lg shadow-2xl">
                    <div className="flex border-b border-gray-700 mb-6">
                        <button
                            ...
                            className={`flex items-center py-3 px-6 font-semibold text-lg transition-all duration-300 ${activeTab === 'Upcoming' ? 'text-black  dark:text-gray-400 border-b-2 border-accent' : '  text-gray-500 hover:text-gray-600 dark:hover:text-white'}`}
                        >
                        ...
                        <button
                            ...
                            className={`flex items-center py-3 px-6 font-semibold text-lg transition-all duration-300 ${activeTab === 'Past' ? 'text-black  dark:text-gray-400 border-b-2 border-accent' : 'text-gray-500 hover:text-gray-600 dark:hover:text-white'}`}
                        >
