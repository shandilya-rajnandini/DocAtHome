...
const Services = () => {
  return (
  <section className="bg-[#D6EEF3] dark:bg-secondary-dark text-black dark:text-primary-text py-20 px-4 ">
      <div className="container mx-auto text-center">
        <h2 className="text-4xl font-bold">SERVICES</h2>
        <div className="w-20 h-1 bg-slate-800 dark:bg-accent-cream my-4 mx-auto"></div>
        <div className="grid md:grid-cols-3 gap-10 mt-12 ">
          {servicesData.map((service, index) => (
            <div key={index} className="bg-[#D6EEF3] dark:bg-primary-dark p-8 rounded-lg text-center shadow-lg hover:shadow-md shadow-gray-300 transform hover:scale-105 transition-transform duration-300 hover:cursor-pointer">
