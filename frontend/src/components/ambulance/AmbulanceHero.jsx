      ...
      <div className="relative z-10 container mx-auto flex items-center h-full p-4">
        <div className="w-full md:w-1/2 text-white">
          ...
          <p className="mt-4 text-lg">
            Fast, Reliable, and Professional Emergency Medical Transportation.
            Available 24/7.
          </p>
        </div>
        <div className="hidden md:flex w-1/2 justify-end">
          ...
          <form
            onSubmit={handleAmbulanceSubmit}
            className="bg-black bg-opacity-70 p-8 rounded-lg w-full max-w-sm"
          >
