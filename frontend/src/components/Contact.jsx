...
const Contact = () => {
  return (
    <section
      id="contact"
      className="bg-amber-100 dark:bg-secondary-dark text-black dark:text-primary-text py-20 px-4"
    >
      <div className="container mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="flex flex-col justify-center space-y-6">
            <div>
              <h3 className="text-2xl font-semibold mb-2 text-slate-800 dark:text-accent-cream">
                Address
              </h3>
              <p className="text-slate-600 dark:text-secondary-text text-xl">
                BIHTA, IIT PATNA
              </p>
            </div>
            <div>
